...
<table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#0000FF">
  <tr align="center">
    <td width="5%">№ п/п</td>
    <td width="30%">Об'ект(Телефон)</td>
    <td width="20%">Невдалий зв'язок</td>
    <td width="20%">Покази лічильника</td>
    <td width="8%">Зона 3</td>
    <td width="9%">Зн.220</td>
    <td width="11%">Напруга в лінії</td>
  </tr>
<?php
		$nom = 0;
...
?>
  ...
  <tr >
    ...
    <td ><?php echo "$db[object]";  echo "($db[nomer])";  ?></td>
    <td ><?php echo "$db2[object]<br>",date( 'H\:i d\-m\-Y', $nootvv); echo " (Неудач $db2[stan], ошибок - $db2[err])"; ?></td>
    <td ><?php  echo ($db2[tr2] * 1000 + $db2[tr1])/10," кВт*год"; ?></td>
    <td ><?php echo date( 'H\:i d\-m\-Y', $tr3v);  ?></td>
    <td ><?php echo date( 'H\:i d\-m\-Y', $pr220v);  ?></td>
    <td><?php echo "$db2[ubat] v"; ?></td>
  </tr>
<?php
