...
function chprinter() {
 ...
 ?>
  ...
  <strong><a href="kart1.php">Складання звіту</a></strong>
  <?php }
...
if(strlen($_POST[invn]) == 9 || strlen($_POST[invn]) == 18)
{  
  if(isset($_POST['tb'])) // если выбран черный картридж
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[ltb], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено</strong> <br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
  
  if(isset($_POST['tc'])) // если выбран  картридж
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[ltc], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено </strong><br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
  
  if(isset($_POST['tm'])) // если выбран картридж
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[ltm], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено</strong> <br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
  
  if(isset($_POST['ty'])) // если выбран  картридж
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[lty], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено</strong> <br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
  
  if(isset($_POST['tcl'])) // если выбран
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[ltcl], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено</strong> <br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
  
  if(isset($_POST['db'])) // если выбран 
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[ldb], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено </strong><br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
  
  if(isset($_POST['dc'])) // если выбран 
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[ldc], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено</strong> <br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
  
  if(isset($_POST['dm'])) // если выбран
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[ldm], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено</strong> <br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
  
  if(isset($_POST['dy'])) // если выбран 
  {
	  if (pg_query($connection, "insert into changelist (yy, invnumber, modelprint, cart, workerid, pidrozdilid) values ($date, '$_POST[invn]', $_POST[printr], $_POST[ldy], $db2[rabotniki_id], $_POST[centry]);")) echo "<strong>Картридж  toner B добавлено</strong> <br>";
	  else echo "<strong style=\"color:#F00\">Картридж  toner B  не вдалося добавити</strong> <br>";	
  }
...
<?php
if (isset($_POST[printr]) && ((strlen($_POST[invn]) != 9) && (strlen($_POST[invn]) != 18))) 
{	
?>
<script type="text/javascript">
chprinter();
</script> 
<strong style="color:#F00">НЕВІРНА ДОВЖИНА ІНВЕНТАРНОГО НОМЕРУ!!! </strong>
<?php
}
?>
